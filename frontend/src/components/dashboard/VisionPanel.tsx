  ...
  return (
    <div className="industrial-card p-0 flex flex-col relative overflow-hidden mb-8 h-[400px]">
      ...
      <div className="relative flex-1 bg-black flex items-center justify-center overflow-hidden">
        ...
        {/* ACTUAL LIVE VIDEO STREAM FROM ESP32-CAM (Static IP on Sensor's SoftAP) */}
           ...
           {isLiveMode ? (
              <>
                ...
                <div id="stream-error" className="hidden absolute inset-0 flex items-center justify-center text-status-red font-mono text-sm z-10 bg-black/80 text-center px-4">
                   [ESP32-CAM OFFLINE]<br/>Waiting for Camera on 192.168.4.2
                </div>
              </>
           ) : (
        ...
        <div className="absolute bottom-6 left-6 text-xs text-white/70 space-y-1 font-mono z-20 bg-black/40 px-2 py-1 rounded">
          <div>CAM-01 {isLiveMode ? '[LIVE - 192.168.4.2]' : '[OFFLINE]'}</div>
        </div>
